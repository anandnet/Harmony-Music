  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: column.children([
          ...
          children: [
            ...
            CustomExpansionTile(
              ...
              children: [
                ListTile(
                  contentPadding: const EdgeInsets.only(left: 5, right: 10),
                  title: 'downloadingFormat'.tr.text.mk,
                  subtitle: 'downloadingFormatDes'.tr.text.bodyMedium.mk,
                  trailing: Obx(
                    () => DropdownButton(
                      dropdownColor: Theme.of(context).cardColor,
                      underline: const SizedBox.shrink(),
                      ...
                      items: [
                        DropdownMenuItem(value: 'opus', child: 'Opus/Ogg'.text.mk),
                        DropdownMenuItem(value: 'm4a', child: 'M4a'.text.mk),
                      ],
                ...
                Obx(() => settingsController.hideDloc.isFalse || isDesktop
                    ? ListTile(
                        ...
                        contentPadding: const EdgeInsets.only(left: 5, right: 10),
                        title: 'downloadLocation'.tr.text.mk,
                        subtitle: Obx(
                ...
                if (GetPlatform.isAndroid)
                  ListTile(
                    contentPadding: const EdgeInsets.only(left: 5, right: 10),
                    title: 'exportDowloadedFiles'.tr.text.mk,
                    subtitle: 'exportDowloadedFilesDes'.tr.text.bodyMedium.mk,
                    isThreeLine: true,
                    onTap: () => showDialog(
                      context: context,
                ...
                if (GetPlatform.isAndroid)
                  ListTile(
                    contentPadding: const EdgeInsets.only(left: 5, right: 10),
                    title: 'exportedFileLocation'.tr.text.mk,
                    subtitle: Obx(() => settingsController.exportLocationPath.value.text.bodyMedium.mk),
                    onTap: () async {
            ...
            CustomExpansionTile(
              ...
              children: [
                ListTile(
                  contentPadding: const EdgeInsets.only(left: 5, right: 10),
                  title: 'backupAppData'.tr.text.mk,
                  subtitle: 'backupSettingsAndPlaylistsDes'.tr.text.bodyMedium.mk,
                  isThreeLine: true,
                  onTap: () => showDialog(
                    context: context,
                ...
                ListTile(
                  contentPadding: const EdgeInsets.only(left: 5, right: 10),
                  title: 'restoreAppData'.tr.text.mk,
                  subtitle: 'restoreSettingsAndPlaylistsDes'.tr.text.bodyMedium.mk,
                  isThreeLine: true,
                  onTap: () => showDialog(
                    context: context,
            ...
            CustomExpansionTile(
              ...
              children: [
                ...
                sizedBox.child(
                  column.children([
                    'Harmony Music'.text.titleLarge.mk,
                    settingsController.currentVersion.text.titleMedium.mk,
                  ]),
                ),
              ],
            )
        ...
        padding.pb38.child(
          "${settingsController.currentVersion} ${"by".tr} anandnet".text.bodySmall.mk,
        ),
      ]),
    );
  }
