...
class MiniPlayerProgressBar extends StatelessWidget {
  const MiniPlayerProgressBar({super.key, required this.progressBarStatus, required this.progressBarColor});
...
class ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final p2 = Offset(total.inSeconds == 0 ? 0 : size.width * (current.inSeconds / total.inSeconds), 1.5);
    final paint = Paint()
