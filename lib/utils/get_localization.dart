...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        "bg": {
          ...
          "dismiss": "Отхвърли",
          "goToDownloadPage":
              "Натисни тук за да отидете на страницата за изтегляне",
          ...
          "downloadingFormatDes":
              "Избери файлов формат при изтегляне. \"Opus\" ще осигури най-доброто качество",
          "minutes": "минути",
          ...
          "homeContentCountDes":
              "Избери броя на първоначално съдържание на началния екран(приблизително). По-малко резултати по-бързо зареждане",
          ...
          "backgroundPlayDes":
              "Активирай/деактивирай изпълнение на музика във фонов режим (Достъпът до приложението може да бъде от системната област, когато приложението работи във фонов режим)",
          ...
          "restoreLastPlaybackSessionDes":
              "Автоматично възстанови последната сесия на възпроизвеждане при стартиране на приложението",
          "cacheHomeScreenData": "Кеш на данни за съдържание на началния екран",
          "cacheHomeScreenDataDes":
              "Активирай кеширане на данни за съдържание на началния екран, Началният екран ще се зареди незабавно, ако тази опция е разрешена",
          ...
          "exportDowloadedFilesDes":
              "Натисни тук, за да изнесете изтегления файл от директорията на приложението във външна директория",
          "clearImgCacheAlert": "Кешът на изображения е изчистен успешно",
          "disableTransitionAnimation": "Деактивирай анимация на прехода",
          "disableTransitionAnimationDes":
              "Активирай тази опция, за да деактивирате анимация на прехода към раздели",
          "clearImgCacheDes":
              "Натисни тук, за да изчистите кеширани миниатюри/изображения. (Не се препоръчва, освен ако не искате да опресните данните от кеширани изображения)",
          ...
          "downloadError3":
              "Неуспешно изтегляне поради мрежова грешка! Моля, опитайте отново",
          ...
          "enableSlidableActionDes":
              "Активирай плъзгащи действия върху плочка на песен",
        ...
        "et": {
          ...
          "downloadError3":
              "Allalaadimine ei õnnestunud võrguühenduse vea tõttu! Palun proovi uuesti",
        ...
        "pt": {
          ...
          "downloadError3":
              "O download falhou devido uma falha na conexão! Tente novamente",
        ...
        "ro": {
          ...
          "openIn": "Deschide cu",
          "queueShufflingDeniedMsg":
              "Coada nu poate fi amestecată când mod de amestecare este activată"
        },
        "ru": {
          "home": "Домой",
          "songs": "Песни",
        ...
        "tr": {
          ...
          "queueShufflingDeniedMsg":
              "Karışık oynatma aktif. Kuyruktaki şarkılar karıştırılamıyor!",
          "queuerearrangingDeniedMsg":
              "Karışık oynatma aktifken kuyruktaki şarkılar düzenlenemez.",
          "networkError": "Ağ hatası! Ağ bağlantınızı kontrol edin.",
          "downloadError2":
              "Sunucu kısıtlaması nedeniyle istenen şarkı indirilemiyor. Tekrar deneyebilirsiniz.",
        ...
        "uk": {
          ...
          "downloadError3":
              "Не вдалося завантажити через помилку мережі! Будь ласка, спробуйте ще раз",
          "content": "Зміст",
